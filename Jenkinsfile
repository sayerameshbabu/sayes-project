        ...
        stage("clone"){
            steps{
                sshPublisher(publishers:
                    [sshPublisherDesc(configName: 'ansible-server-ansibleadmin', transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: '''ansible-playbook -i hosts.ini installations-playbook.yml;
