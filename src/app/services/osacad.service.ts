...
export class OsacadService {
  ...
  private storeCourseProgressC: any = {};
  ...
  getCertificates() {
    const httpReq: HttpReq = new HttpReq();
    httpReq.type = this.REST_TYPE_GET;
    httpReq.url = '/certificate/getAllCertificates';
    httpReq.showLoader = true;
    httpReq.body = {};
    return this.httpService.restCall(httpReq);
  }
  generateCertificate(data) {
    const httpReq: HttpReq = new HttpReq();
    httpReq.type = this.REST_TYPE_POST;
    httpReq.url = '/certificate/generateCertificate';
    httpReq.showLoader = true;
    httpReq.body = data;
    return this.httpService.restCall(httpReq);
  }
  verifyCertificate(data, id) {
    const httpReq: HttpReq = new HttpReq();
    httpReq.type = this.REST_TYPE_POST;
    const formData = new FormData();
    formData.append('file', data);
    httpReq.url = `/certificate/verifyCertificate/${id}`;
    httpReq.showLoader = true;
  ...
  get _storeCourseProgress() {
    return this.storeCourseProgressC;
  }
  set _storeCourseProgress(value) {
    this.storeCourseProgressC = value;
  }
